...
import _HomeView from '../../views/HomeView.vue'
      ...
      fc.assert(
        fc.property(fc.constantFrom(...SECTION_IDS), sectionId => {
          ...
          const hasAriaLabelledby =
            componentContent.includes(`id="${sectionId}"`) &&
    ...
    it('Property 9: For any project with image, alt text includes project name', () => {
      ...
      fc.assert(
        fc.property(projectArb, project => {
          ...
          const altIncludesName =
            img.exists() && img.attributes('alt')?.includes(project.name)
